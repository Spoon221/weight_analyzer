...
namespace _qt_qml_untitled1_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appuntitled1)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appuntitled1))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appuntitled1)() {
    return 1;
}
